...
use App\Modules\ProductTechnicalCharacteristic\ViewModels\ProductTechnicalCharacteristicIndexVM;
use App\Http\Controllers\Controller;
use App\Helpers\Helper;
use App\Modules\ProductTechnicalCharacteristic\ViewModels\ProductTechnicalCharacteristicShowVM;


class ProductTechnicalCharacteristicController extends Controller
{
    /**
    ...
    {
        $response = Helper::createSuccessResponse(ProductTechnicalCharacteristicIndexVM::toArray());
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function show($ProductTechnicalCharacteristic)
    {
        //
     ...
     *
     * @param UpdateProductTechnicalCharacteristicRequest $updateProductTechnicalCharacteristicRequest
     * @param ProductTechnicalCharacteristic $ProductTechnicalCharacteristic
     * @return \Illuminate\Http\JsonResponse
     */
